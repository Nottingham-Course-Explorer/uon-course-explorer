...
def test_format_assessment():
    ...
    assert format_assessment("Exam 1", "75.00", "Written (in-person)", "2Hr 30Mins", "Written examination."
                             ) == "75% Exam 1 (2-hour-30-minute): Written examination."
    assert format_assessment("Participation", "100.00", "Participation", "", ""
                             ) == "100% Participation"


def test_format_class():
    assert format_class("Lecture", "11 weeks", "1 week","1 hours and 30 minutes"
                        ) == "One 1-hour-30-minute lecture per week for 11 weeks"
    assert format_class("Seminar", "10 weeks", "2 week", "2 hours"
                        ) == "Two 2-hour seminars per week for 10 weeks"
    assert format_class("Lecture", "9 weeks", "35 week", "1 hour"
